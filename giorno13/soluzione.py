...
def piega(coordinate, x_max, y_max, mosse):
    foglio = []
...
def parte1(coordinate, x_max, y_max, mosse):
    totale = piega(coordinate, x_max, y_max, mosse)
    print(totale)


def parte2(coordinate, x_max, y_max, mosse):
    totale = piega(coordinate, x_max, y_max, mosse)
    print(totale)
...
m = [mosse[0]]
parte1(coordinate, x_max, y_max, m)
#parte2(coordinate, x_max, y_max, mosse)
